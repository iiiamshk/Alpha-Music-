...
import 'package:alpha/Helpers/handle_native.dart';
import 'package:alpha/Helpers/import_export_playlist.dart';
import 'package:alpha/Helpers/logging.dart';
...
import 'package:alpha/providers/audio_service_provider.dart';
...
Future<void> openHiveBox(String boxName, {bool limit = false}) async {
  final box = await Hive.openBox(boxName).onError((error, stackTrace) async {
    ...
    if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
      dbFile = File('$dirPath/Alpha/$boxName.hive');
      lockFile = File('$dirPath/Alpha/$boxName.lock');
    }
    await dbFile.delete();
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    HomeWidget.setAppGroupId('com.inhr.alpha');
